...
import com.drivill.courier.databinding.FragmentThankYouBinding;
...
public class ThankYouFragment extends Fragment {
    FragmentThankYouBinding mBinding;
    ...
    void initUI() {
        ...
        mBinding.buttonQuitNow.setOnClickListener(new View.OnClickListener() {
            @Override
